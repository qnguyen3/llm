...
def parse_arge():
    ...
    parser.add_argument(
        "--dataset_path", type=str, default="qnguyen3/multilang_chat_full", help="Path to dataset."
    )
    parser.add_argument(
    ...
    parser.add_argument(
        "--lr", type=float, default=2e-4, help="Learning rate to use for training."
    )
    parser.add_argument(
...
def training_function(args):
    ...
    output_dir = ".outout/falcon-180b-ft"
